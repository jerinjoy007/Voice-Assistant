...
with open('C:\\Users\\safee\\Desktop\\jerin\\Voice-Assistant\\NUBI\\static\\intents.json') as file:
    data = json.load(file)
df = pd.read_csv('C:\\Users\\safee\\Desktop\\jerin\\Voice-Assistant\\NUBI\\static\\books.csv', error_bad_lines = False)
def num_into_obj(x):
    if x>=0 and x<=1:
...
def chat(request):
    ...
    model = keras.models.load_model('C:\\Users\\safee\\Desktop\\jerin\\Voice-Assistant\\NUBI\\static\\voice_assistant')
    with open('C:\\Users\\safee\\Desktop\\jerin\\Voice-Assistant\\NUBI\\static\\tokenizer.pickle','rb') as handle:
        tokenizer = pickle.load(handle)
    with open('C:\\Users\\safee\\Desktop\\jerin\\Voice-Assistant\\NUBI\\static\\lbl_encoder.pickle','rb') as ecn:
